...
public class Hard extends Player{
    ...
    private boolean isCorner(Cell[] board){
        if (board[0].getValue() == "N" || board[2].getValue() == "N" || board[6].getValue() == "N" || board[8].getValue() == "N"){
            return true;
        }
        return false;
    }
    ...
    public Cell[] move(Cell[] board) {
        ...
        if (isCorner(board) && board[4].getValue() == "N"){
            board[4].value = getToken();
            return board;
        }
